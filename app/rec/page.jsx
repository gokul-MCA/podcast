...
export default function PodcastForm() {
  ...
  const submitPodcast = () => {
    if (
      !selectedAudio ||
      !selectedImage ||
      // !category || Select value doesnot work in Imported Shadcn
      !episode ||
      !heading ||
      !description
    ) {
      alert("Please ensure audio before uploading.");
  ...
  return (
    <div className="p-2">
      ...
      <div className="pl-10 pt-3 flex gap-2">
        <Button variant='outline' className=' m-2'><Link href='/' className="flex items-center gap-1" ><IoArrowBackOutline className="w-4 h-4" /> Back</Link></Button>
